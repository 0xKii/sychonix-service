...
```
archwayd tx staking unbond $(archwayd keys show wallet --bech val -a) 1000000000000000000aarch --from wallet --chain-id archway-1 --gas-adjustment=1.4 --chain-id archway-1
```

Send Token to another wallet
```
archwayd tx bank send wallet <TO_WALLET_ADDRESS> 1000000uebl --from wallet --chain-id archway-1
```
...
```
archwayd tx gov vote 1 yes --from wallet --chain-id archway-1 --gas-adjustment=1.4 --chain-id archway-1
```
